...
const LabTechnicianDashboard: React.FC<LabTechnicianDashboardProps> = (props) => {
  ...
  return (
    <DashboardLayout sidebar={<Sidebar activeView={activeView} setActiveView={setActiveView} />} header={<DashboardHeader {...props} notifications={[]} onMarkNotificationsAsRead={()=>{}} title="Lab Technician Dashboard" />}>
      {renderContent()}
    </DashboardLayout>
  );
};
